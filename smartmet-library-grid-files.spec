...
- Fixed handling of global data longitudes
...
* Wed Mar 18 2026 Andris Pavēnis <andris.pavenis@fmi.fi> 26.3.18-2.fmi
- Fix RockyLinux 9 and 10 build (missing include)
...
- Fixed problem in returning data coordinates
