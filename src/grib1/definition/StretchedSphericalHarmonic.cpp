...
void StretchedSphericalHarmonic::getAttributeList(
  ...
  try {
    ...
    sprintf(name, "%sStretchedSphericalHarmonic.RepresentationType",
            prefix.c_str());
    attributeList.addAttribute(name, toString(mRepresentationType));
    sprintf(name, "%sStretchedSphericalHarmonic.RepresentationMode",
            prefix.c_str());
...
StretchedSphericalHarmonic::getGridStretching() const {
  try {
