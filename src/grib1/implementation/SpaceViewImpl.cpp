...
T::Coordinate_vec SpaceViewImpl::getGridCoordinates() const
{
...
T::Dimensions_opt SpaceViewImpl::getGridDimensions() const
{
  try
  {
    return {};
...
bool SpaceViewImpl::getGridPointByLatLon(double lat,double lon,double& grid_i,double& grid_j) const
{
  try
  {
