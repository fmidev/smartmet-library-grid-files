...
GridDefinition* SphericalHarmonicImpl::createGridDefinition() const
{
  try
  {
    return (GridDefinition*)new SphericalHarmonicImpl(*this);
  }
  catch (...)
  {
...
T::Coordinate_svec SphericalHarmonicImpl::getGridOriginalCoordinatesNoCache() const
{
...
T::Dimensions SphericalHarmonicImpl::getGridDimensions() const
{
  try
  {
    return T::Dimensions();
...
bool SphericalHarmonicImpl::getGridPointByLatLonCoordinates(double lat,double lon,double& grid_i,double& grid_j) const
{
  try
  {
