...
T::Coordinate_vec StretchedRotatedGaussianImpl::getGridCoordinates() const
{
...
bool StretchedRotatedGaussianImpl::getGridPointByLatLon(double lat,double lon,double& grid_i,double& grid_j) const
{
  try
  {
