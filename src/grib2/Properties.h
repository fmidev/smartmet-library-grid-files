...
namespace Property
{
  ...
  {
    public:
      static const uint FirstProperty                               = 2100;
  ...
  class GridSection
  {
    public:
      ...
      static const uint LastProperty                          = LambertConformal::LastProperty;
  };
  ...
  class ProductSection
  {
    public:
      ...
      static const uint LastProperty                          = ProbabilitySettings::LastProperty;
  };
