...
//   you should write them into the 'AerosolOpticalPropertiesProductImpl.*'
//   files.
// ***********************************************************************
...
void AerosolOpticalPropertiesProduct::getAttributeList(
...
void AerosolOpticalPropertiesProduct::print(std::ostream &stream, uint level,
 ...
 * mParameterAerosolOptical} attribute. */

const ParameterAerosolOpticalSettings *
AerosolOpticalPropertiesProduct::getParameterAerosolOptical() const {
  try {
...
AerosolOpticalPropertiesProduct::getPointInTime() const {
  try {
    return &mPointInTime;
  } catch (...) {
    throw SmartMet::Spine::Exception(BCP, "Operation failed!", NULL);
...
AerosolOpticalPropertiesProduct::getHorizontal() const {
  try {
    return &mHorizontal;
  } catch (...) {
    throw SmartMet::Spine::Exception(BCP, "Operation failed!", NULL);
