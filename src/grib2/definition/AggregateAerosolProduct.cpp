...
AggregateAerosolProduct::AggregateAerosolProduct(const AggregateAerosolProduct &other) : ProductDefinition(other) {
  try {
...
void AggregateAerosolProduct::getAttributeList(std::string prefix, T::AttributeList &attributeList) const {
  try {
    char name[300];
