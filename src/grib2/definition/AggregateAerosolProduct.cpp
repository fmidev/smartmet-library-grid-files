...
bool AggregateAerosolProduct::getAttributeValue(const char *attributeName, std::string &attributeValue) const {
  try {
...
bool AggregateAerosolProduct::hasAttributeValue(const char *attributeName, const char *attributeValue) const {
  try {
...
T::Hash AggregateAerosolProduct::countHash() const {
  try {
    std::size_t seed = 0;
    return seed;
  } catch (...) {
