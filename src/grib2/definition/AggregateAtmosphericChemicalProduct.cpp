...
//   you should write them into the 'AggregateAtmosphericChemicalProductImpl.*'
//   files.
// ***********************************************************************
...
void AggregateAtmosphericChemicalProduct::getAttributeList(
...
void AggregateAtmosphericChemicalProduct::print(std::ostream &stream,
                                                uint level,
...
AggregateAtmosphericChemicalProduct::getParameterChemical() const {
  try {
...
AggregateAtmosphericChemicalProduct::getHorizontal() const {
  try {
    return &mHorizontal;
  } catch (...) {
    throw SmartMet::Spine::Exception(BCP, "Operation failed!", NULL);
...
AggregateAtmosphericChemicalProduct::getStatistical() const {
  try {
    return &mStatistical;
  } catch (...) {
    throw SmartMet::Spine::Exception(BCP, "Operation failed!", NULL);
