...
//   you should write them into the 'AreaProcessedCrossSectionProductImpl.*'
//   files.
// ***********************************************************************
...
void AreaProcessedCrossSectionProduct::getAttributeList(
  ...
  try {
    ...
    sprintf(name,
            "%sAreaProcessedCrossSectionProduct.HorizontalDimensionProcessed",
            prefix.c_str());
    attributeList.addAttribute(name, toString(mHorizontalDimensionProcessed));
    sprintf(name, "%sAreaProcessedCrossSectionProduct.TreatmentOfMissingData",
            prefix.c_str());
    attributeList.addAttribute(name, toString(mTreatmentOfMissingData));
    sprintf(name,
            "%sAreaProcessedCrossSectionProduct.TypeOfStatisticalProcessing",
            prefix.c_str());
    attributeList.addAttribute(name, toString(mTypeOfStatisticalProcessing));
    sprintf(name, "%sAreaProcessedCrossSectionProduct.StartOfRange",
            prefix.c_str());
    attributeList.addAttribute(name, toString(mStartOfRange));
    sprintf(name, "%sAreaProcessedCrossSectionProduct.EndOfRange",
            prefix.c_str());
    attributeList.addAttribute(name, toString(mEndOfRange));
    sprintf(name, "%sAreaProcessedCrossSectionProduct.NumberOfDataValues",
            prefix.c_str());
...
void AreaProcessedCrossSectionProduct::print(std::ostream &stream, uint level,
                                             uint optionFlags) const {
  try {
    stream << space(level) << "AreaProcessedCrossSectionProduct\n";
    mParameter.print(stream, level + 1, optionFlags);
    stream << space(level) << "- HorizontalDimensionProcessed = "
           << toString(mHorizontalDimensionProcessed) << "\n";
    stream << space(level)
           << "- TreatmentOfMissingData = " << toString(mTreatmentOfMissingData)
           << "\n";
    ...
    stream << space(level) << "- EndOfRange = " << toString(mEndOfRange)
           << "\n";
    stream << space(level)
           << "- NumberOfDataValues = " << toString(mNumberOfDataValues)
           << "\n";
  } catch (...) {
    throw SmartMet::Spine::Exception(BCP, "Operation failed!", NULL);
  }
...
AreaProcessedCrossSectionProduct::getParameter() const {
  try {
    return &mParameter;
  } catch (...) {
    throw SmartMet::Spine::Exception(BCP, "Operation failed!", NULL);
 ...
 * mHorizontalDimensionProcessed} attribute. */

const T::UInt8_opt &
AreaProcessedCrossSectionProduct::getHorizontalDimensionProcessed() const {
  try {
...
/*! \brief The method returns the value of the {@link mTreatmentOfMissingData}
 * attribute. */

const T::UInt8_opt &
AreaProcessedCrossSectionProduct::getTreatmentOfMissingData() const {
  try {
...
const T::UInt8_opt &
AreaProcessedCrossSectionProduct::getTypeOfStatisticalProcessing() const {
  try {
...
/*! \brief The method returns the value of the {@link mNumberOfDataValues}
 * attribute. */

const T::UInt16_opt &
AreaProcessedCrossSectionProduct::getNumberOfDataValues() const {
  try {
