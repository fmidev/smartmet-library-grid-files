...
protected:
  ...
  // #
  //
  // # TEMPLATE 4.1002, Cross-section of analysis and forecast, averaged or
  ...
  // codetable[1] horizontalDimensionProcessed
  // ('4.220.table',masterDir,localDir) : dump;
  ...
  // # (e.g. below ground)
  // codetable[1] treatmentOfMissingData ('4.221.table',masterDir,localDir) :
  // dump;
