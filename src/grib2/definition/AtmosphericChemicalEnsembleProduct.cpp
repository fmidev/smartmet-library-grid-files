...
//   you should write them into the 'AtmosphericChemicalEnsembleProductImpl.*'
//   files.
// ***********************************************************************
...
void AtmosphericChemicalEnsembleProduct::getAttributeList(
...
void AtmosphericChemicalEnsembleProduct::print(std::ostream &stream, uint level,
...
AtmosphericChemicalEnsembleProduct::getParameterChemical() const {
  try {
...
AtmosphericChemicalEnsembleProduct::getPointInTime() const {
  try {
    return &mPointInTime;
  } catch (...) {
    throw SmartMet::Spine::Exception(BCP, "Operation failed!", NULL);
...
AtmosphericChemicalEnsembleProduct::getHorizontal() const {
  try {
    return &mHorizontal;
  } catch (...) {
    throw SmartMet::Spine::Exception(BCP, "Operation failed!", NULL);
