...
void AtmosphericChemicalProduct::getAttributeList(
...
void AtmosphericChemicalProduct::print(std::ostream &stream, uint level,
...
AtmosphericChemicalProduct::getParameterChemical() const {
  try {
