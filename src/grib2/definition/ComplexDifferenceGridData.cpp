...
#include "grib2/definition/ComplexDifferenceGridData.h"
...
void ComplexDifferenceGridData::getAttributeList(
...
void ComplexDifferenceGridData::print(std::ostream &stream, uint level,
