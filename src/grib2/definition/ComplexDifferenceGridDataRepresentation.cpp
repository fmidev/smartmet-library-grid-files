...
void ComplexDifferenceGridDataRepresentation::getAttributeList(
  ...
  try {
    ...
    sprintf(
        name,
        "%sComplexDifferenceGridDataRepresentation.GroupSplittingMethodUsed",
        prefix.c_str());
    attributeList.addAttribute(name, toString(mGroupSplittingMethodUsed));
    sprintf(
        name,
        "%sComplexDifferenceGridDataRepresentation.MissingValueManagementUsed",
        prefix.c_str());
    attributeList.addAttribute(name, toString(mMissingValueManagementUsed));
    sprintf(name, "%sComplexDifferenceGridDataRepresentation."
    ...
    sprintf(
        name,
        "%sComplexDifferenceGridDataRepresentation.NumberOfGroupsOfDataValues",
        prefix.c_str());
    attributeList.addAttribute(name, toString(mNumberOfGroupsOfDataValues));
    sprintf(name,
            "%sComplexDifferenceGridDataRepresentation.ReferenceForGroupWidths",
            prefix.c_str());
    ...
    sprintf(
        name,
        "%sComplexDifferenceGridDataRepresentation.ReferenceForGroupLengths",
        prefix.c_str());
    ...
    sprintf(name,
            "%sComplexDifferenceGridDataRepresentation.TrueLengthOfLastGroup",
            prefix.c_str());
    ...
    sprintf(
        name,
        "%sComplexDifferenceGridDataRepresentation.OrderOfSpatialDifferencing",
        prefix.c_str());
...
void ComplexDifferenceGridDataRepresentation::print(std::ostream &stream,
                                                    uint level,
  ...
  try {
    ...
    stream << space(level) << "- NumberOfBitsForScaledGroupLengths = "
           << toString(mNumberOfBitsForScaledGroupLengths) << "\n";
    stream << space(level) << "- OrderOfSpatialDifferencing = "
           << toString(mOrderOfSpatialDifferencing) << "\n";
    stream << space(level) << "- NumberOfOctetsExtraDescriptors = "
           << toString(mNumberOfOctetsExtraDescriptors) << "\n";
  } catch (...) {
    throw SmartMet::Spine::Exception(BCP, "Operation failed!", NULL);
  }
}
...
ComplexDifferenceGridDataRepresentation::getPacking() const {
  try {
    return &mPacking;
  } catch (...) {
    throw SmartMet::Spine::Exception(BCP, "Operation failed!", NULL);
...
ComplexDifferenceGridDataRepresentation::getOriginalValues() const {
  try {
...
const T::UInt8_opt &
ComplexDifferenceGridDataRepresentation::getGroupSplittingMethodUsed() const {
  try {
...
const T::UInt8_opt &
ComplexDifferenceGridDataRepresentation::getMissingValueManagementUsed() const {
  try {
...
const T::UInt32_opt &
ComplexDifferenceGridDataRepresentation::getPrimaryMissingValueSubstitute()
    const {
  try {
...
const T::UInt32_opt &
ComplexDifferenceGridDataRepresentation::getSecondaryMissingValueSubstitute()
    const {
  try {
...
const T::UInt32_opt &
ComplexDifferenceGridDataRepresentation::getNumberOfGroupsOfDataValues() const {
  try {
...
const T::UInt8_opt &
ComplexDifferenceGridDataRepresentation::getReferenceForGroupWidths() const {
  try {
...
const T::UInt8_opt &
ComplexDifferenceGridDataRepresentation::getNumberOfBitsUsedForTheGroupWidths()
    const {
  try {
...
const T::UInt32_opt &
ComplexDifferenceGridDataRepresentation::getReferenceForGroupLengths() const {
  try {
...
const T::UInt8_opt &
ComplexDifferenceGridDataRepresentation::getLengthIncrementForTheGroupLengths()
    const {
  try {
...
const T::UInt32_opt &
ComplexDifferenceGridDataRepresentation::getTrueLengthOfLastGroup() const {
  try {
...
const T::UInt8_opt &
ComplexDifferenceGridDataRepresentation::getNumberOfBitsForScaledGroupLengths()
    const {
  try {
...
/*! \brief The method returns the value of the {@link
 * mOrderOfSpatialDifferencing} attribute. */

const T::UInt8_opt &
ComplexDifferenceGridDataRepresentation::getOrderOfSpatialDifferencing() const {
  try {
...
/*! \brief The method returns the value of the {@link
 * mNumberOfOctetsExtraDescriptors} attribute. */

const T::UInt8_opt &
ComplexDifferenceGridDataRepresentation::getNumberOfOctetsExtraDescriptors()
    const {
  try {
