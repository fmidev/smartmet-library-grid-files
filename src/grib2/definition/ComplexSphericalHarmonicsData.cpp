...
bool ComplexSphericalHarmonicsData::getAttributeValue(const char *attributeName, std::string &attributeValue) const {
  try {
...
bool ComplexSphericalHarmonicsData::hasAttributeValue(const char *attributeName, const char *attributeValue) const {
  try {
