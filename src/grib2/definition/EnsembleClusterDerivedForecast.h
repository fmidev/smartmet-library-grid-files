...
public:
  ...
  const RectangularClusterSettings *getRectangularCluster() const;
...
protected:
  ...
  // #
  //
  // # TEMPLATE 4.3, Derived forecasts based on a cluster of ensemble members
  // over a rectangular area at a horizontal level or in a horizontal layer at a
  // point in time
  //
