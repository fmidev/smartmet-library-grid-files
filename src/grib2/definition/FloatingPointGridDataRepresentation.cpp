...
//   you should write them into the 'FloatingPointGridDataRepresentationImpl.*'
//   files.
// ***********************************************************************
...
void FloatingPointGridDataRepresentation::getAttributeList(
    std::string prefix, T::AttributeList &attributeList) const {
  try {
    char name[300];
    sprintf(name, "%sFloatingPointGridDataRepresentation.Precision",
            prefix.c_str());
...
void FloatingPointGridDataRepresentation::print(std::ostream &stream,
                                                uint level,
