...
void ForecastError::getAttributeList(std::string prefix,
...
void ForecastError::print(std::ostream &stream, uint level,
...
/*! \brief The method returns the pointer to the {@link mNormalProduct}
 * attribute. */
