...
protected:
  ...
  // codetable[1] typeOfFirstFixedSurface ('4.5.table',masterDir,localDir) :
  // dump,no_copy,edition_specific,string_type;

  T::UInt8_opt mTypeOfFirstFixedSurface;

  // meta unitsOfFirstFixedSurface codetable_units(typeOfFirstFixedSurface) :
  // dump;
  // meta nameOfFirstFixedSurface codetable_title(typeOfFirstFixedSurface) :
  // dump;
  //
  // #  Scale factor of first fixed surface
  // signed[1] scaleFactorOfFirstFixedSurface = missing()  :
  // can_be_missing,dump,no_copy,edition_specific;

  T::Int8_opt mScaleFactorOfFirstFixedSurface;

  //
  // #  Scaled value of first fixed surface
  // unsigned[4] scaledValueOfFirstFixedSurface = missing()  :
  // can_be_missing,dump,no_copy,edition_specific;
  ...
  // codetable[1] typeOfSecondFixedSurface ('4.5.table',masterDir,localDir) =
  // 255 : dump,no_copy,edition_specific;

  T::UInt8_opt mTypeOfSecondFixedSurface;

  // meta unitsOfSecondFixedSurface codetable_units(typeOfSecondFixedSurface) :
  // dump;
  // meta nameOfSecondFixedSurface codetable_title(typeOfSecondFixedSurface) :
  // dump;
  //
  // #  Scale factor of second fixed surface
  // signed[1] scaleFactorOfSecondFixedSurface = missing() :
  // can_be_missing,dump,no_copy,edition_specific;
  ...
  // unsigned[4] scaledValueOfSecondFixedSurface = missing() :
  // can_be_missing,dump,no_copy,edition_specific;
  ...
  //   typeOfSecondFixedSurface=255;}
  //   'isobaricInPa' = {typeOfFirstFixedSurface=100;
  //   typeOfSecondFixedSurface=255; pressureUnits='Pa'; }
  //   'isobaricInhPa' = {typeOfFirstFixedSurface=100; pressureUnits='hPa';
  //   typeOfSecondFixedSurface=255;}
  //   'isobaricLayer' = {typeOfFirstFixedSurface=100;
  ...
  //   'generalVertical' = {genVertHeightCoords=1; typeOfFirstFixedSurface=150;
  //   NV=6;}
  //   'generalVerticalLayer' = {genVertHeightCoords=1;
  //   typeOfFirstFixedSurface=150; typeOfSecondFixedSurface=150; NV=6;}
  //
  //   'depthBelowSea' = {typeOfFirstFixedSurface=160;
  //   typeOfSecondFixedSurface=255;}
  //   'entireAtmosphere' =
  //   {typeOfFirstFixedSurface=1;typeOfSecondFixedSurface=8;}
  ...
  //   'snowLayer' = {typeOfFirstFixedSurface=114;
  //   typeOfSecondFixedSurface=114;}
  // }
  //
