...
//   you should write them into the 'LogarithmicGridDataRepresentationImpl.*'
//   files.
// ***********************************************************************
...
void LogarithmicGridDataRepresentation::getAttributeList(
  ...
  try {
    ...
    sprintf(name, "%sLogarithmicGridDataRepresentation.PreProcessingParameter",
            prefix.c_str());
...
void LogarithmicGridDataRepresentation::print(std::ostream &stream, uint level,
