...
void ParameterAerosolOpticalSettings::getAttributeList(
    std::string prefix, T::AttributeList &attributeList) const {
  try {
    char name[300];
    sprintf(name, "%sParameterAerosolOpticalSettings.ParameterCategory",
            prefix.c_str());
    attributeList.addAttribute(name, toString(mParameterCategory));
    sprintf(name, "%sParameterAerosolOpticalSettings.ParameterNumber",
            prefix.c_str());
    attributeList.addAttribute(name, toString(mParameterNumber));
    sprintf(name, "%sParameterAerosolOpticalSettings.AerosolType",
            prefix.c_str());
    attributeList.addAttribute(name, toString(mAerosolType));
    sprintf(name, "%sParameterAerosolOpticalSettings.TypeOfSizeInterval",
            prefix.c_str());
    attributeList.addAttribute(name, toString(mTypeOfSizeInterval));
    sprintf(name, "%sParameterAerosolOpticalSettings.ScaleFactorOfFirstSize",
            prefix.c_str());
    attributeList.addAttribute(name, toString(mScaleFactorOfFirstSize));
    sprintf(name, "%sParameterAerosolOpticalSettings.ScaledValueOfFirstSize",
            prefix.c_str());
    attributeList.addAttribute(name, toString(mScaledValueOfFirstSize));
    sprintf(name, "%sParameterAerosolOpticalSettings.ScaleFactorOfSecondSize",
            prefix.c_str());
    attributeList.addAttribute(name, toString(mScaleFactorOfSecondSize));
    sprintf(name, "%sParameterAerosolOpticalSettings.ScaledValueOfSecondSize",
            prefix.c_str());
    attributeList.addAttribute(name, toString(mScaledValueOfSecondSize));
    sprintf(name, "%sParameterAerosolOpticalSettings.TypeOfWavelengthInterval",
            prefix.c_str());
    attributeList.addAttribute(name, toString(mTypeOfWavelengthInterval));
    sprintf(name,
            "%sParameterAerosolOpticalSettings.ScaleFactorOfFirstWavelength",
            prefix.c_str());
    attributeList.addAttribute(name, toString(mScaleFactorOfFirstWavelength));
    sprintf(name,
            "%sParameterAerosolOpticalSettings.ScaledValueOfFirstWavelength",
            prefix.c_str());
    attributeList.addAttribute(name, toString(mScaledValueOfFirstWavelength));
    sprintf(name,
            "%sParameterAerosolOpticalSettings.ScaleFactorOfSecondWavelength",
            prefix.c_str());
    attributeList.addAttribute(name, toString(mScaleFactorOfSecondWavelength));
    sprintf(name,
            "%sParameterAerosolOpticalSettings.ScaledValueOfSecondWavelength",
            prefix.c_str());
    attributeList.addAttribute(name, toString(mScaledValueOfSecondWavelength));
    sprintf(name, "%sParameterAerosolOpticalSettings.TypeOfGeneratingProcess",
            prefix.c_str());
    attributeList.addAttribute(name, toString(mTypeOfGeneratingProcess));
    sprintf(name, "%sParameterAerosolOpticalSettings.BackgroundProcess",
            prefix.c_str());
    attributeList.addAttribute(name, toString(mBackgroundProcess));
    sprintf(name,
            "%sParameterAerosolOpticalSettings.GeneratingProcessIdentifier",
            prefix.c_str());
    attributeList.addAttribute(name, toString(mGeneratingProcessIdentifier));
    sprintf(name, "%sParameterAerosolOpticalSettings.HoursAfterDataCutoff",
            prefix.c_str());
    attributeList.addAttribute(name, toString(mHoursAfterDataCutoff));
    sprintf(name, "%sParameterAerosolOpticalSettings.MinutesAfterDataCutoff",
            prefix.c_str());
    attributeList.addAttribute(name, toString(mMinutesAfterDataCutoff));
    sprintf(name,
            "%sParameterAerosolOpticalSettings.IndicatorOfUnitOfTimeRange",
            prefix.c_str());
    attributeList.addAttribute(name, toString(mIndicatorOfUnitOfTimeRange));
    sprintf(name, "%sParameterAerosolOpticalSettings.ForecastTime",
            prefix.c_str());
...
void ParameterAerosolOpticalSettings::print(std::ostream &stream, uint level,
  ...
  try {
    ...
    stream << space(level) << "- TypeOfWavelengthInterval = "
           << toString(mTypeOfWavelengthInterval) << "\n";
    stream << space(level) << "- ScaleFactorOfFirstWavelength = "
           << toString(mScaleFactorOfFirstWavelength) << "\n";
    stream << space(level) << "- ScaledValueOfFirstWavelength = "
           << toString(mScaledValueOfFirstWavelength) << "\n";
    stream << space(level) << "- ScaleFactorOfSecondWavelength = "
           << toString(mScaleFactorOfSecondWavelength) << "\n";
    stream << space(level) << "- ScaledValueOfSecondWavelength = "
           << toString(mScaledValueOfSecondWavelength) << "\n";
...
const T::UInt8_opt &
ParameterAerosolOpticalSettings::getParameterCategory() const {
  try {
...
const T::UInt8_opt &
ParameterAerosolOpticalSettings::getParameterNumber() const {
  try {
...
const T::UInt8_opt &
ParameterAerosolOpticalSettings::getTypeOfSizeInterval() const {
  try {
...
const T::Int8_opt &
ParameterAerosolOpticalSettings::getScaleFactorOfFirstSize() const {
  try {
...
const T::Int32_opt &
ParameterAerosolOpticalSettings::getScaledValueOfFirstSize() const {
  try {
...
const T::Int8_opt &
ParameterAerosolOpticalSettings::getScaleFactorOfSecondSize() const {
  try {
...
const T::Int32_opt &
ParameterAerosolOpticalSettings::getScaledValueOfSecondSize() const {
  try {
...
/*! \brief The method returns the value of the {@link mTypeOfWavelengthInterval}
 * attribute. */

const T::UInt8_opt &
ParameterAerosolOpticalSettings::getTypeOfWavelengthInterval() const {
  try {
 ...
 * mScaleFactorOfFirstWavelength} attribute. */

const T::Int8_opt &
ParameterAerosolOpticalSettings::getScaleFactorOfFirstWavelength() const {
  try {
...
/*! \brief The method returns the value of the {@link
 * mScaledValueOfFirstWavelength} attribute. */

const T::Int32_opt &
ParameterAerosolOpticalSettings::getScaledValueOfFirstWavelength() const {
  try {
...
/*! \brief The method returns the value of the {@link
 * mScaleFactorOfSecondWavelength} attribute. */

const T::Int8_opt &
ParameterAerosolOpticalSettings::getScaleFactorOfSecondWavelength() const {
  try {
...
/*! \brief The method returns the value of the {@link
 * mScaledValueOfSecondWavelength} attribute. */

const T::Int32_opt &
ParameterAerosolOpticalSettings::getScaledValueOfSecondWavelength() const {
  try {
...
const T::UInt8_opt &
ParameterAerosolOpticalSettings::getTypeOfGeneratingProcess() const {
  try {
...
const T::UInt8_opt &
ParameterAerosolOpticalSettings::getBackgroundProcess() const {
  try {
...
const T::UInt8_opt &
ParameterAerosolOpticalSettings::getGeneratingProcessIdentifier() const {
  try {
...
const T::UInt16_opt &
ParameterAerosolOpticalSettings::getHoursAfterDataCutoff() const {
  try {
...
const T::UInt8_opt &
ParameterAerosolOpticalSettings::getMinutesAfterDataCutoff() const {
  try {
...
const T::UInt8_opt &
ParameterAerosolOpticalSettings::getIndicatorOfUnitOfTimeRange() const {
  try {
