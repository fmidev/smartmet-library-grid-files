...
namespace SmartMet {
namespace GRIB2 {
/*! \brief The class is automatically created from the template (4.parameter_partition).*/
...
public:
  ...
  void setPartitionTable(T::UInt8_opt partitionTable);
  const T::UInt8_opt &getNumberOfPartitions() const;
  void setNumberOfPartitions(T::UInt8_opt numberOfPartitions);
  const T::UInt16_opt &getPartitionItems() const;
  void setPartitionItems(T::UInt16_opt partitionItems);
  const T::UInt16_opt &getPartitionNumber() const;
  void setPartitionNumber(T::UInt16_opt partitionNumber);
