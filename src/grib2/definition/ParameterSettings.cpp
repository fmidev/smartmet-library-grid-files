...
bool ParameterSettings::getAttributeValue(const char *attributeName, std::string &attributeValue) const {
  try {
...
bool ParameterSettings::hasAttributeValue(const char *attributeName, const char *attributeValue) const {
  try {
...
T::Hash ParameterSettings::countHash() const {
  try {
    std::size_t seed = 0;
