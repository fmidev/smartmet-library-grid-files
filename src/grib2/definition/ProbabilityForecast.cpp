...
bool ProbabilityForecast::getAttributeValue(const char *attributeName, std::string &attributeValue) const {
  try {
    ...
    if (mHorizontal.getAttributeValue(attributeName, attributeValue))
      return true;
    if (mProbability.getAttributeValue(attributeName, attributeValue))
      return true;
    return false;
  } catch (...) {
    throw Fmi::Exception(BCP, "Operation failed", nullptr);
...
bool ProbabilityForecast::hasAttributeValue(const char *attributeName, const char *attributeValue) const {
  try {
    ...
    if (mHorizontal.hasAttributeValue(attributeName, attributeValue))
      return true;
    if (mProbability.hasAttributeValue(attributeName, attributeValue))
      return true;
    return false;
  } catch (...) {
    throw Fmi::Exception(BCP, "Operation failed", nullptr);
...
T::Hash ProbabilityForecast::countHash() const {
  try {
    std::size_t seed = 0;
    return seed;
  } catch (...) {
