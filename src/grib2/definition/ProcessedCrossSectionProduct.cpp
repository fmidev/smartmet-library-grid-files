...
void ProcessedCrossSectionProduct::getAttributeList(
...
void ProcessedCrossSectionProduct::print(std::ostream &stream, uint level,
...
ProcessedCrossSectionProduct::getStatistical() const {
  try {
    return &mStatistical;
  } catch (...) {
    throw SmartMet::Spine::Exception(BCP, "Operation failed!", NULL);
