...
bool ProcessedHovmollerProduct::getAttributeValue(const char *attributeName, std::string &attributeValue) const {
  try {
...
bool ProcessedHovmollerProduct::hasAttributeValue(const char *attributeName, const char *attributeValue) const {
  try {
...
T::Hash ProcessedHovmollerProduct::countHash() const {
  try {
    std::size_t seed = 0;
    return seed;
  } catch (...) {
