...
void SimulatedSatelliteEnsembleProduct::getAttributeList(
...
void SimulatedSatelliteEnsembleProduct::print(std::ostream &stream, uint level,
...
SimulatedSatelliteEnsembleProduct::getSimulatedSatelliteProduct() const {
  try {
