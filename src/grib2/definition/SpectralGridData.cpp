...
#include "grib2/definition/SpectralGridData.h"
...
void SpectralGridData::getAttributeList(std::string prefix,
...
void SpectralGridData::print(std::ostream &stream, uint level,
