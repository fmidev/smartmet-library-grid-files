...
//   you should write them into the 'SpectralGridDataRepresentationImpl.*'
//   files.
// ***********************************************************************
...
void SpectralGridDataRepresentation::getAttributeList(
  ...
  try {
    ...
    sprintf(name, "%sSpectralGridDataRepresentation.CcsdsFlags",
            prefix.c_str());
    attributeList.addAttribute(name, toString(mCcsdsFlags));
    sprintf(name, "%sSpectralGridDataRepresentation.CcsdsBlockSize",
            prefix.c_str());
...
void SpectralGridDataRepresentation::print(std::ostream &stream, uint level,
...
SpectralGridDataRepresentation::getOriginalValues() const {
  try {
...
/*! \brief The method returns the value of the {@link mCcsdsBlockSize}
 * attribute. */
