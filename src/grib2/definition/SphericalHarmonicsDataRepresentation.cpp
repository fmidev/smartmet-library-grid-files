...
//   you should write them into the 'SphericalHarmonicsDataRepresentationImpl.*'
//   files.
// ***********************************************************************
...
void SphericalHarmonicsDataRepresentation::getAttributeList(
  ...
  try {
    ...
    sprintf(name,
            "%sSphericalHarmonicsDataRepresentation.LaplacianScalingFactor",
            prefix.c_str());
    ...
    sprintf(name,
            "%sSphericalHarmonicsDataRepresentation.UnpackedSubsetPrecision",
            prefix.c_str());
...
void SphericalHarmonicsDataRepresentation::print(std::ostream &stream,
                                                 uint level,
...
SphericalHarmonicsDataRepresentation::getPacking() const {
  try {
    return &mPacking;
  } catch (...) {
    throw SmartMet::Spine::Exception(BCP, "Operation failed!", NULL);
...
const T::Int32_opt &
SphericalHarmonicsDataRepresentation::getLaplacianScalingFactor() const {
  try {
...
const T::UInt8_opt &
SphericalHarmonicsDataRepresentation::getUnpackedSubsetPrecision() const {
  try {
