...
void StatisticalSettings::getAttributeList(
    std::string prefix, T::AttributeList &attributeList) const {
  try {
    char name[300];
    sprintf(name, "%sStatisticalSettings.YearOfEndOfOverallTimeInterval",
            prefix.c_str());
    attributeList.addAttribute(name, toString(mYearOfEndOfOverallTimeInterval));
    sprintf(name, "%sStatisticalSettings.MonthOfEndOfOverallTimeInterval",
            prefix.c_str());
    attributeList.addAttribute(name,
                               toString(mMonthOfEndOfOverallTimeInterval));
    sprintf(name, "%sStatisticalSettings.DayOfEndOfOverallTimeInterval",
            prefix.c_str());
    attributeList.addAttribute(name, toString(mDayOfEndOfOverallTimeInterval));
    sprintf(name, "%sStatisticalSettings.HourOfEndOfOverallTimeInterval",
            prefix.c_str());
    attributeList.addAttribute(name, toString(mHourOfEndOfOverallTimeInterval));
    sprintf(name, "%sStatisticalSettings.MinuteOfEndOfOverallTimeInterval",
            prefix.c_str());
    attributeList.addAttribute(name,
                               toString(mMinuteOfEndOfOverallTimeInterval));
    sprintf(name, "%sStatisticalSettings.SecondOfEndOfOverallTimeInterval",
            prefix.c_str());
    attributeList.addAttribute(name,
                               toString(mSecondOfEndOfOverallTimeInterval));
    ...
    sprintf(name, "%sStatisticalSettings.NumberOfMissingInStatisticalProcess",
            prefix.c_str());
    attributeList.addAttribute(name,
                               toString(mNumberOfMissingInStatisticalProcess));
    sprintf(name, "%sStatisticalSettings.TypeOfStatisticalProcessing",
            prefix.c_str());
    ...
    sprintf(name, "%sStatisticalSettings.IndicatorOfUnitForTimeRange",
            prefix.c_str());
    ...
    sprintf(name, "%sStatisticalSettings.IndicatorOfUnitForTimeIncrement",
            prefix.c_str());
    attributeList.addAttribute(name,
                               toString(mIndicatorOfUnitForTimeIncrement));
...
void StatisticalSettings::print(std::ostream &stream, uint level,
                                uint optionFlags) const {
  try {
    stream << space(level) << "StatisticalSettings\n";
    stream << space(level) << "- YearOfEndOfOverallTimeInterval = "
           << toString(mYearOfEndOfOverallTimeInterval) << "\n";
    stream << space(level) << "- MonthOfEndOfOverallTimeInterval = "
           << toString(mMonthOfEndOfOverallTimeInterval) << "\n";
    stream << space(level) << "- DayOfEndOfOverallTimeInterval = "
           << toString(mDayOfEndOfOverallTimeInterval) << "\n";
    stream << space(level) << "- HourOfEndOfOverallTimeInterval = "
           << toString(mHourOfEndOfOverallTimeInterval) << "\n";
    stream << space(level) << "- MinuteOfEndOfOverallTimeInterval = "
           << toString(mMinuteOfEndOfOverallTimeInterval) << "\n";
    stream << space(level) << "- SecondOfEndOfOverallTimeInterval = "
           << toString(mSecondOfEndOfOverallTimeInterval) << "\n";
    stream << space(level)
           << "- NumberOfTimeRange = " << toString(mNumberOfTimeRange) << "\n";
    stream << space(level) << "- NumberOfMissingInStatisticalProcess = "
           << toString(mNumberOfMissingInStatisticalProcess) << "\n";
    stream << space(level) << "- TypeOfStatisticalProcessing = "
           << toString(mTypeOfStatisticalProcessing) << "\n";
    stream << space(level)
           << "- TypeOfTimeIncrement = " << toString(mTypeOfTimeIncrement)
           << "\n";
    stream << space(level) << "- IndicatorOfUnitForTimeRange = "
           << toString(mIndicatorOfUnitForTimeRange) << "\n";
    stream << space(level)
           << "- LengthOfTimeRange = " << toString(mLengthOfTimeRange) << "\n";
    stream << space(level) << "- IndicatorOfUnitForTimeIncrement = "
           << toString(mIndicatorOfUnitForTimeIncrement) << "\n";
 ...
 * mYearOfEndOfOverallTimeInterval} attribute. */

const T::UInt16_opt &
StatisticalSettings::getYearOfEndOfOverallTimeInterval() const {
  try {
...
/*! \brief The method returns the value of the {@link
 * mMonthOfEndOfOverallTimeInterval} attribute. */

const T::UInt8_opt &
StatisticalSettings::getMonthOfEndOfOverallTimeInterval() const {
  try {
...
/*! \brief The method returns the value of the {@link
 * mDayOfEndOfOverallTimeInterval} attribute. */

const T::UInt8_opt &
StatisticalSettings::getDayOfEndOfOverallTimeInterval() const {
  try {
...
/*! \brief The method returns the value of the {@link
 * mHourOfEndOfOverallTimeInterval} attribute. */

const T::UInt8_opt &
StatisticalSettings::getHourOfEndOfOverallTimeInterval() const {
  try {
...
/*! \brief The method returns the value of the {@link
 * mMinuteOfEndOfOverallTimeInterval} attribute. */

const T::UInt8_opt &
StatisticalSettings::getMinuteOfEndOfOverallTimeInterval() const {
  try {
...
/*! \brief The method returns the value of the {@link
 * mSecondOfEndOfOverallTimeInterval} attribute. */

const T::UInt8_opt &
StatisticalSettings::getSecondOfEndOfOverallTimeInterval() const {
  try {
...
/*! \brief The method returns the value of the {@link mNumberOfTimeRange}
 * attribute. */
...
/*! \brief The method returns the value of the {@link
 * mNumberOfMissingInStatisticalProcess} attribute. */

const T::UInt32_opt &
StatisticalSettings::getNumberOfMissingInStatisticalProcess() const {
  try {
...
/*! \brief The method returns the value of the {@link
 * mTypeOfStatisticalProcessing} attribute. */

const T::UInt8_opt &
StatisticalSettings::getTypeOfStatisticalProcessing() const {
  try {
...
/*! \brief The method returns the value of the {@link
 * mIndicatorOfUnitForTimeRange} attribute. */

const T::UInt8_opt &
StatisticalSettings::getIndicatorOfUnitForTimeRange() const {
  try {
...
/*! \brief The method returns the value of the {@link mLengthOfTimeRange}
 * attribute. */
...
/*! \brief The method returns the value of the {@link
 * mIndicatorOfUnitForTimeIncrement} attribute. */

const T::UInt8_opt &
StatisticalSettings::getIndicatorOfUnitForTimeIncrement() const {
  try {
