...
protected:
  ...
  // alias
  // totalNumberOfDataValuesMissingInStatisticalProcess=numberOfMissingInStatisticalProcess;
  //
  ...
  //  codetable[1] typeOfStatisticalProcessing ('4.10.table',masterDir,localDir)
  //  : edition_specific;
  ...
  //  codetable[1]  typeOfTimeIncrement ('4.11.table',masterDir,localDir) = 2 :
  //  edition_specific;

  T::UInt8_opt mTypeOfTimeIncrement;

  //  alias
  //  typeOfTimeIncrementBetweenSuccessiveFieldsUsedInTheStatisticalProcessing=typeOfTimeIncrement;
  //
  //  #  Indicator of unit of time for time range over which statistical
  //  processing is done
  //  codetable[1]  indicatorOfUnitForTimeRange ('4.4.table',masterDir,localDir)
  //  =1 ;

  T::UInt8_opt mIndicatorOfUnitForTimeRange;

  //
  //  #  Length of the time range over which statistical processing is done, in
  ...
  //  fields used
  //  codetable[1]  indicatorOfUnitForTimeIncrement
  //  ('4.4.table',masterDir,localDir)=255 ;
  ...
  //   }
  //   meta startStep
  //   step_in_units(forecastTime,indicatorOfUnitOfTimeRange,stepUnits,
  ...
  //
  // meta time.validityDate
  // validity_date(date,dataTime,step,stepUnits,yearOfEndOfOverallTimeInterval,
  //     monthOfEndOfOverallTimeInterval,dayOfEndOfOverallTimeInterval) :
  //     no_copy;
  // meta time.validityTime
  // validity_time(date,dataTime,step,stepUnits,hourOfEndOfOverallTimeInterval,
