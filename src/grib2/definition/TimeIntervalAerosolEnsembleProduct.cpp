...
void TimeIntervalAerosolEnsembleProduct::getAttributeList(
...
void TimeIntervalAerosolEnsembleProduct::print(std::ostream &stream, uint level,
...
TimeIntervalAerosolEnsembleProduct::getParameterAerosol() const {
  try {
...
TimeIntervalAerosolEnsembleProduct::getHorizontal() const {
  try {
    return &mHorizontal;
  } catch (...) {
    throw SmartMet::Spine::Exception(BCP, "Operation failed!", NULL);
...
TimeIntervalAerosolEnsembleProduct::getStatistical() const {
  try {
    return &mStatistical;
  } catch (...) {
    throw SmartMet::Spine::Exception(BCP, "Operation failed!", NULL);
