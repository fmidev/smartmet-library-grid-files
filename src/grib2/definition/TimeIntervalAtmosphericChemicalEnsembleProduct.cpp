...
void TimeIntervalAtmosphericChemicalEnsembleProduct::read(
...
void TimeIntervalAtmosphericChemicalEnsembleProduct::getAttributeList(
    std::string prefix, T::AttributeList &attributeList) const {
  try {
    char name[300];
    sprintf(name, "%sTimeIntervalAtmosphericChemicalEnsembleProduct.",
            prefix.c_str());
...
void TimeIntervalAtmosphericChemicalEnsembleProduct::print(
...
/*! \brief The method returns the pointer to the {@link mParameterChemical}
 * attribute. */

const ParameterChemicalSettings *
TimeIntervalAtmosphericChemicalEnsembleProduct::getParameterChemical() const {
  try {
...
TimeIntervalAtmosphericChemicalEnsembleProduct::getHorizontal() const {
  try {
    return &mHorizontal;
  } catch (...) {
    throw SmartMet::Spine::Exception(BCP, "Operation failed!", NULL);
...
const EpsSettings *
TimeIntervalAtmosphericChemicalEnsembleProduct::getEps() const {
  try {
    return &mEps;
  } catch (...) {
    throw SmartMet::Spine::Exception(BCP, "Operation failed!", NULL);
...
TimeIntervalAtmosphericChemicalEnsembleProduct::getStatistical() const {
  try {
    return &mStatistical;
  } catch (...) {
    throw SmartMet::Spine::Exception(BCP, "Operation failed!", NULL);
