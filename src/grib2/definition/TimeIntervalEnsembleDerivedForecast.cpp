...
//   you should write them into the 'TimeIntervalEnsembleDerivedForecastImpl.*'
//   files.
// ***********************************************************************
...
void TimeIntervalEnsembleDerivedForecast::getAttributeList(
...
void TimeIntervalEnsembleDerivedForecast::print(std::ostream &stream,
                                                uint level,
...
TimeIntervalEnsembleDerivedForecast::getParameter() const {
  try {
    return &mParameter;
  } catch (...) {
    throw SmartMet::Spine::Exception(BCP, "Operation failed!", NULL);
...
TimeIntervalEnsembleDerivedForecast::getHorizontal() const {
  try {
    return &mHorizontal;
  } catch (...) {
    throw SmartMet::Spine::Exception(BCP, "Operation failed!", NULL);
...
TimeIntervalEnsembleDerivedForecast::getStatistical() const {
  try {
    return &mStatistical;
  } catch (...) {
    throw SmartMet::Spine::Exception(BCP, "Operation failed!", NULL);
