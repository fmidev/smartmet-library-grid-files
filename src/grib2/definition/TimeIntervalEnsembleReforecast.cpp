...
//   you should write them into the 'TimeIntervalEnsembleReforecastImpl.*'
//   files.
// ***********************************************************************
...
void TimeIntervalEnsembleReforecast::getAttributeList(
...
void TimeIntervalEnsembleReforecast::print(std::ostream &stream, uint level,
...
TimeIntervalEnsembleReforecast::getHorizontal() const {
  try {
    return &mHorizontal;
  } catch (...) {
    throw SmartMet::Spine::Exception(BCP, "Operation failed!", NULL);
...
const ReforecastSettings *
TimeIntervalEnsembleReforecast::getReforecast() const {
  try {
    return &mReforecast;
  } catch (...) {
    throw SmartMet::Spine::Exception(BCP, "Operation failed!", NULL);
...
TimeIntervalEnsembleReforecast::getStatistical() const {
  try {
    return &mStatistical;
  } catch (...) {
    throw SmartMet::Spine::Exception(BCP, "Operation failed!", NULL);
