...
void TimeIntervalEnsembleReforecast::write(DataWriter &dataWriter) {
  try {
...
bool TimeIntervalEnsembleReforecast::getAttributeValue(const char *attributeName, std::string &attributeValue) const {
  try {
...
bool TimeIntervalEnsembleReforecast::hasAttributeValue(const char *attributeName, const char *attributeValue) const {
  try {
...
T::Hash TimeIntervalEnsembleReforecast::countHash() const {
  try {
    std::size_t seed = 0;
    return seed;
  } catch (...) {
...
uint TimeIntervalEnsembleReforecast::getTemplateNumber() const {
  return 61;
}
