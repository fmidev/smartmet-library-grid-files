...
void TimeIntervalPercentileForecast::getAttributeList(
...
void TimeIntervalPercentileForecast::print(std::ostream &stream, uint level,
...
TimeIntervalPercentileForecast::getHorizontal() const {
  try {
    return &mHorizontal;
  } catch (...) {
    throw SmartMet::Spine::Exception(BCP, "Operation failed!", NULL);
...
const PercentileSettings *
TimeIntervalPercentileForecast::getPercentile() const {
  try {
    return &mPercentile;
  } catch (...) {
    throw SmartMet::Spine::Exception(BCP, "Operation failed!", NULL);
...
TimeIntervalPercentileForecast::getStatistical() const {
  try {
    return &mStatistical;
  } catch (...) {
    throw SmartMet::Spine::Exception(BCP, "Operation failed!", NULL);
