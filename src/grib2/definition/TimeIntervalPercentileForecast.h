...
//   you should write them into the 'TimeIntervalPercentileForecastImpl.*'
//   files.
// ***********************************************************************
...
public:
  ...
  const PercentileSettings *getPercentile() const;
...
protected:
  ...
  // #
  //
  // # TEMPLATE 4.10, Percentile forecasts at a horizontal level or in a
