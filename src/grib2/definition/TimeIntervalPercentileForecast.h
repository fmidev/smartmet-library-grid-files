...
namespace SmartMet {
namespace GRIB2 {
/*! \brief The class is automatically created from the template (4.10).*/

class TimeIntervalPercentileForecast : public ProductDefinition {
public:
  TimeIntervalPercentileForecast();
  TimeIntervalPercentileForecast(const TimeIntervalPercentileForecast &other);
  virtual ~TimeIntervalPercentileForecast();
