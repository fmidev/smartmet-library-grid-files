...
bool Unstructured::getAttributeValue(const char *attributeName, std::string &attributeValue) const {
  try {
    ...
    if (strcasecmp(attributeName, "NumberOfGridUsed") == 0) {
      attributeValue = toString(mNumberOfGridUsed);
      return true;
    }
    if (strcasecmp(attributeName, "NumberOfGridInReference") == 0) {
      attributeValue = toString(mNumberOfGridInReference);
      return true;
    }
    if (strcasecmp(attributeName, "UuidOfHGrid") == 0) {
      attributeValue = toString(mUuidOfHGrid);
      return true;
    }
    return false;
  } catch (...) {
...
bool Unstructured::hasAttributeValue(const char *attributeName, const char *attributeValue) const {
  try {
    if (attributeName == nullptr || attributeValue == nullptr)
      return false;
    if (strcasecmp(attributeName, "ShapeOfTheEarth") == 0 && strcasecmp(attributeValue, toString(mShapeOfTheEarth).c_str()) == 0)
      return true;
    if (strcasecmp(attributeName, "NumberOfGridUsed") == 0 && strcasecmp(attributeValue, toString(mNumberOfGridUsed).c_str()) == 0)
      return true;
    if (strcasecmp(attributeName, "NumberOfGridInReference") == 0 && strcasecmp(attributeValue, toString(mNumberOfGridInReference).c_str()) == 0)
      return true;
    if (strcasecmp(attributeName, "UuidOfHGrid") == 0 && strcasecmp(attributeValue, toString(mUuidOfHGrid).c_str()) == 0)
      return true;
    return false;
  } catch (...) {
    throw Fmi::Exception(BCP, "Operation failed", nullptr);
