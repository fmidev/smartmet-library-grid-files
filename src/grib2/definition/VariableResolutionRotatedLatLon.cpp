...
//   you should write them into the 'VariableResolutionRotatedLatLonImpl.*'
//   files.
// ***********************************************************************
...
void VariableResolutionRotatedLatLon::getAttributeList(
...
void VariableResolutionRotatedLatLon::print(std::ostream &stream, uint level,
...
VariableResolutionRotatedLatLon::getEarthShape() const {
  try {
    return &mEarthShape;
  } catch (...) {
    throw SmartMet::Spine::Exception(BCP, "Operation failed!", NULL);
...
VariableResolutionRotatedLatLon::getVariableLatLon() const {
  try {
