#include "AerosolEnsembleProductImpl.h"
...
void AerosolEnsembleProductImpl::read(MemoryReader& memoryReader)
{
  try
  {
    AerosolEnsembleProduct::read(memoryReader);
  }
  catch (...)
  {
    throw Fmi::Exception(BCP,"Operation failed!",nullptr);
...
T::ParamLevel AerosolEnsembleProductImpl::getGribParameterLevel() const
{
  throw Fmi::Exception(BCP, "Not implemented!");
}
...
T::ParamLevelId AerosolEnsembleProductImpl::getGribParameterLevelId() const
{
  throw Fmi::Exception(BCP, "Not implemented!");
}
