...
const T::UInt8_opt AerosolOpticalPropertiesProductImpl::getGribParameterCategory() const
{
  try
  {
    return mParameterAerosolOptical.getParameterCategory();
  }
  catch (...)
  {
    throw Fmi::Exception(BCP, "Operation failed!", nullptr);
...
const T::UInt8_opt AerosolOpticalPropertiesProductImpl::getGribParameterNumber() const
{
  try
  {
    return mParameterAerosolOptical.getParameterNumber();
  }
  catch (...)
  {
    throw Fmi::Exception(BCP, "Operation failed!", nullptr);
...
T::UInt8_opt AerosolOpticalPropertiesProductImpl::getGeneratingProcessIdentifier() const
{
  try
  {
    return mParameterAerosolOptical.getGeneratingProcessIdentifier();
  }
  catch (...)
  {
    throw Fmi::Exception(BCP, "Operation failed!", nullptr);
...
T::TimeString AerosolOpticalPropertiesProductImpl::countForecastStartTime(T::TimeString referenceTime) const
{
  try
  {
    ...
    auto indicator = mParameterAerosolOptical.getIndicatorOfUnitOfTimeRange();
    if (!indicator)
