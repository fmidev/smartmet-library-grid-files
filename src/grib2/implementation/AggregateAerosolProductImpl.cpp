...
T::TimeString AggregateAerosolProductImpl::getForecastStartTime(T::TimeString referenceTime) const
{
...
T::TimeString AggregateAerosolProductImpl::getForecastEndTime(T::TimeString referenceTime) const
{
  throw SmartMet::Spine::Exception(BCP, "Not implemented!");
}
