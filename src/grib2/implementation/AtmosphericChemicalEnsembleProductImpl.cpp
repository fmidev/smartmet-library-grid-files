...
AtmosphericChemicalEnsembleProductImpl::AtmosphericChemicalEnsembleProductImpl(const AtmosphericChemicalEnsembleProductImpl& other)
:AtmosphericChemicalEnsembleProduct(other)
{
}
...
ProductDefinition* AtmosphericChemicalEnsembleProductImpl::createProductDefinition() const
{
  try
  {
    return (ProductDefinition*)new AtmosphericChemicalEnsembleProductImpl(*this);
  }
  catch (...)
  {
...
const T::UInt8_opt AtmosphericChemicalEnsembleProductImpl::getGribParameterCategory() const
{
  try
  {
...
const T::UInt8_opt AtmosphericChemicalEnsembleProductImpl::getGribParameterNumber() const
{
  try
  {
...
T::UInt8_opt AtmosphericChemicalEnsembleProductImpl::getGeneratingProcessIdentifier() const
{
  try
  {
...
T::TimeString AtmosphericChemicalEnsembleProductImpl::countForecastStartTime(T::TimeString referenceTime) const
{
  try
  {
...
T::TimeString AtmosphericChemicalEnsembleProductImpl::getForecastTime(T::TimeString referenceTime) const
{
  try
  {
    std::string t1;
