...
AzimuthRangeImpl::AzimuthRangeImpl(const AzimuthRangeImpl& other)
:AzimuthRange(other)
{
}
...
GridDefinition* AzimuthRangeImpl::createGridDefinition() const
{
  try
  {
    return (GridDefinition*)new AzimuthRangeImpl(*this);
  }
  catch (...)
  {
...
void AzimuthRangeImpl::read(MemoryReader& memoryReader)
{
  try
  {
...
T::Coordinate_vec AzimuthRangeImpl::getGridOriginalCoordinates() const
{
...
T::Dimensions AzimuthRangeImpl::getGridDimensions() const
{
  try
  {
    return T::Dimensions();
...
bool AzimuthRangeImpl::getGridPointByLatLonCoordinates(double lat,double lon,double& grid_i,double& grid_j) const
{
  try
  {
...
void AzimuthRangeImpl::initSpatialReference()
{
  try
  {
