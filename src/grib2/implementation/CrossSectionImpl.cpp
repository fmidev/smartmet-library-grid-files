...
CrossSectionImpl::CrossSectionImpl(const CrossSectionImpl& other)
:CrossSection(other)
{
}
...
GridDefinition* CrossSectionImpl::createGridDefinition() const
{
  try
  {
    return (GridDefinition*)new CrossSectionImpl(*this);
  }
  catch (...)
  {
...
void CrossSectionImpl::read(MemoryReader& memoryReader)
{
  try
  {
    CrossSection::read(memoryReader);
  }
  catch (...)
  {
    throw Fmi::Exception(BCP,"Operation failed!",nullptr);
...
T::Dimensions CrossSectionImpl::getGridDimensions() const
{
  try
  {
...
bool CrossSectionImpl::getGridPointByLatLonCoordinates(double lat,double lon,double& grid_i,double& grid_j) const
{
  try
  {
...
void CrossSectionImpl::initSpatialReference()
{
  try
  {
