...
T::TimeString CrossSectionProductImpl::getForecastStartTime(T::TimeString referenceTime) const
{
...
T::TimeString CrossSectionProductImpl::getForecastEndTime(T::TimeString referenceTime) const
{
  throw SmartMet::Spine::Exception(BCP, "Not implemented!");
}
