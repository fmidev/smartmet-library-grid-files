...
HovmollerImpl::HovmollerImpl(const HovmollerImpl& other)
:Hovmoller(other)
{
}
...
void HovmollerImpl::read(MemoryReader& memoryReader)
{
  try
  {
    Hovmoller::read(memoryReader);
  }
  catch (...)
  {
    throw Fmi::Exception(BCP,"Operation failed!",nullptr);
...
T::Coordinate_svec HovmollerImpl::getGridOriginalCoordinatesNoCache() const
{
...
bool HovmollerImpl::getGridPointByLatLonCoordinates(double lat,double lon,double& grid_i,double& grid_j) const
{
  try
  {
...
void HovmollerImpl::initSpatialReference()
{
  try
  {
