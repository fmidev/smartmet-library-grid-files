...
IrregularLatLonImpl::IrregularLatLonImpl(const IrregularLatLonImpl& other)
:IrregularLatLon(other)
{
}
...
void IrregularLatLonImpl::read(MemoryReader& memoryReader)
{
  try
  {
    IrregularLatLon::read(memoryReader);
  }
  catch (...)
  {
    throw Fmi::Exception(BCP,"Operation failed!",nullptr);
...
T::Coordinate_svec IrregularLatLonImpl::getGridOriginalCoordinatesNoCache() const
{
...
void IrregularLatLonImpl::initSpatialReference()
{
  try
  {
