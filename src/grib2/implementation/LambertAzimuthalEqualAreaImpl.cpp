...
T::Coordinate_vec LambertAzimuthalEqualAreaImpl::getGridCoordinates() const
{
...
T::Dimensions_opt LambertAzimuthalEqualAreaImpl::getGridDimensions() const
{
  try
  {
...
bool LambertAzimuthalEqualAreaImpl::getGridPointByLatLon(double lat,double lon,double& grid_i,double& grid_j) const
{
  try
  {
