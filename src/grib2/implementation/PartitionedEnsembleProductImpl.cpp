...
T::TimeString PartitionedEnsembleProductImpl::getForecastStartTime(T::TimeString referenceTime) const
{
...
T::TimeString PartitionedEnsembleProductImpl::getForecastEndTime(T::TimeString referenceTime) const
{
  throw SmartMet::Spine::Exception(BCP, "Not implemented!");
}
