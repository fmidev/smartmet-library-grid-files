...
T::TimeString ProcessedCrossSectionProductImpl::getForecastStartTime(T::TimeString referenceTime) const
{
...
T::TimeString ProcessedCrossSectionProductImpl::getForecastEndTime(T::TimeString referenceTime) const
{
  throw SmartMet::Spine::Exception(BCP, "Not implemented!");
}
