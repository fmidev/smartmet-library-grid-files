...
T::Dimensions_opt RotatedGaussianImpl::getGridDimensions() const
{
  try
  {
...
bool RotatedGaussianImpl::getGridPointByLatLon(double lat,double lon,double& grid_i,double& grid_j) const
{
  try
  {
