...
{
  mGridProjection = T::GridProjectionValue::RotatedSphericalHarmonic;
}
...
RotatedSphericalHarmonicImpl::RotatedSphericalHarmonicImpl(const RotatedSphericalHarmonicImpl& other)
:RotatedSphericalHarmonic(other)
{
}
...
GridDefinition* RotatedSphericalHarmonicImpl::createGridDefinition() const
{
  try
  {
    return (GridDefinition*)new RotatedSphericalHarmonicImpl(*this);
  }
  catch (...)
  {
...
void RotatedSphericalHarmonicImpl::read(MemoryReader& memoryReader)
{
  try
  {
    RotatedSphericalHarmonic::read(memoryReader);
  }
  catch (...)
  {
    throw Fmi::Exception(BCP,"Operation failed!",nullptr);
...
T::Coordinate_svec RotatedSphericalHarmonicImpl::getGridOriginalCoordinatesNoCache() const
{
...
T::Dimensions RotatedSphericalHarmonicImpl::getGridDimensions() const
{
  try
  {
    return T::Dimensions();
...
void RotatedSphericalHarmonicImpl::initSpatialReference()
{
  try
  {
