...
T::Coordinate_vec StretchedGaussianImpl::getGridCoordinates() const
{
...
bool StretchedGaussianImpl::getGridPointByLatLon(double lat,double lon,double& grid_i,double& grid_j) const
{
  try
  {
