...
T::TimeString TimeIntervalAtmosphericChemicalEnsembleProductImpl::getForecastStartTime(T::TimeString referenceTime) const
{
...
T::TimeString TimeIntervalAtmosphericChemicalEnsembleProductImpl::getForecastEndTime(T::TimeString referenceTime) const
{
  throw SmartMet::Spine::Exception(BCP, "Not implemented!");
}
