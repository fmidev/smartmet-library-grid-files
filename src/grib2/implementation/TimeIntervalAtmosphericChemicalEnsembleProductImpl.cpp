...
const T::UInt8_opt TimeIntervalAtmosphericChemicalEnsembleProductImpl::getGribParameterCategory() const
{
  try
  {
...
const T::UInt8_opt TimeIntervalAtmosphericChemicalEnsembleProductImpl::getGribParameterNumber() const
{
  try
  {
...
T::UInt8_opt TimeIntervalAtmosphericChemicalEnsembleProductImpl::getGeneratingProcessIdentifier() const
{
  try
  {
...
T::TimeString TimeIntervalAtmosphericChemicalEnsembleProductImpl::countForecastStartTime(T::TimeString referenceTime) const
{
  try
  {
