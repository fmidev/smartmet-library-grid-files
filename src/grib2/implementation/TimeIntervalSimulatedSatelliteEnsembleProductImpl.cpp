...
T::TimeString TimeIntervalSimulatedSatelliteEnsembleProductImpl::getForecastStartTime(T::TimeString referenceTime) const
{
...
T::TimeString TimeIntervalSimulatedSatelliteEnsembleProductImpl::getForecastEndTime(T::TimeString referenceTime) const
{
  throw SmartMet::Spine::Exception(BCP, "Not implemented!");
}
