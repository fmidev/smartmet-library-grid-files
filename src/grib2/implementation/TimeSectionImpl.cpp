...
TimeSectionImpl::TimeSectionImpl(const TimeSectionImpl& other)
:TimeSection(other)
{
}
...
GridDefinition* TimeSectionImpl::createGridDefinition() const
{
  try
  {
    return (GridDefinition*)new TimeSectionImpl(*this);
  }
  catch (...)
  {
...
void TimeSectionImpl::read(MemoryReader& memoryReader)
{
  try
  {
    TimeSection::read(memoryReader);
  }
  catch (...)
  {
    throw SmartMet::Spine::Exception(BCP,exception_operation_failed,nullptr);
...
T::Coordinate_vec TimeSectionImpl::getGridOriginalCoordinates() const
{
...
T::Dimensions TimeSectionImpl::getGridDimensions() const
{
  try
  {
    return T::Dimensions();
...
bool TimeSectionImpl::getGridPointByLatLonCoordinates(double lat,double lon,double& grid_i,double& grid_j) const
{
  try
  {
...
void TimeSectionImpl::initSpatialReference()
{
  try
  {
