...
TriangularImpl::TriangularImpl(const TriangularImpl& other)
:Triangular(other)
{
}
...
GridDefinition* TriangularImpl::createGridDefinition() const
{
  try
  {
    return (GridDefinition*)new TriangularImpl(*this);
  }
  catch (...)
  {
...
void TriangularImpl::read(MemoryReader& memoryReader)
{
  try
  {
    Triangular::read(memoryReader);
  }
  catch (...)
  {
    throw SmartMet::Spine::Exception(BCP,exception_operation_failed,nullptr);
...
T::Coordinate_vec TriangularImpl::getGridCoordinates() const
{
...
T::Dimensions TriangularImpl::getGridDimensions() const
{
  try
  {
    return {};
...
bool TriangularImpl::getGridPointByLatLonCoordinates(double lat,double lon,double& grid_i,double& grid_j) const
{
  try
  {
...
void TriangularImpl::initSpatialReference()
{
  try
  {
