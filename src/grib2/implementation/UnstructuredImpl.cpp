...
UnstructuredImpl::UnstructuredImpl(const UnstructuredImpl& other)
:Unstructured(other)
{
}
...
void UnstructuredImpl::read(MemoryReader& memoryReader)
{
  try
  {
    Unstructured::read(memoryReader);
  }
  catch (...)
  {
    throw Fmi::Exception(BCP,"Operation failed!",nullptr);
...
T::Coordinate_svec UnstructuredImpl::getGridOriginalCoordinatesNoCache() const
{
...
bool UnstructuredImpl::getGridPointByLatLonCoordinates(double lat,double lon,double& grid_i,double& grid_j) const
{
  try
  {
...
void UnstructuredImpl::initSpatialReference()
{
  try
  {
