...
{
  mGridProjection = T::GridProjectionValue::VariableResolutionLatLon;
}
...
VariableResolutionLatLonImpl::VariableResolutionLatLonImpl(const VariableResolutionLatLonImpl& other)
:VariableResolutionLatLon(other)
{
}
...
void VariableResolutionLatLonImpl::read(MemoryReader& memoryReader)
{
  try
  {
    VariableResolutionLatLon::read(memoryReader);
  }
  catch (...)
  {
    throw Fmi::Exception(BCP,"Operation failed!",nullptr);
...
T::Coordinate_svec VariableResolutionLatLonImpl::getGridOriginalCoordinatesNoCache() const
{
...
bool VariableResolutionLatLonImpl::getGridPointByLatLonCoordinates(double lat,double lon,double& grid_i,double& grid_j) const
{
  try
  {
...
void VariableResolutionLatLonImpl::initSpatialReference()
{
  try
  {
