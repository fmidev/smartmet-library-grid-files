...
VariableResolutionRotatedLatLonImpl::VariableResolutionRotatedLatLonImpl(const VariableResolutionRotatedLatLonImpl& other)
:VariableResolutionRotatedLatLon(other)
{
}
...
GridDefinition* VariableResolutionRotatedLatLonImpl::createGridDefinition() const
{
  try
  {
    return (GridDefinition*)new VariableResolutionRotatedLatLonImpl(*this);
  }
  catch (...)
  {
...
void VariableResolutionRotatedLatLonImpl::read(MemoryReader& memoryReader)
{
  try
  {
    VariableResolutionRotatedLatLon::read(memoryReader);
  }
  catch (...)
  {
    throw SmartMet::Spine::Exception(BCP,exception_operation_failed,nullptr);
...
T::Coordinate_vec VariableResolutionRotatedLatLonImpl::getGridCoordinates() const
{
...
T::Dimensions VariableResolutionRotatedLatLonImpl::getGridDimensions() const
{
  try
  {
...
bool VariableResolutionRotatedLatLonImpl::getGridPointByLatLonCoordinates(double lat,double lon,double& grid_i,double& grid_j) const
{
  try
  {
...
void VariableResolutionRotatedLatLonImpl::initSpatialReference()
{
  try
  {
