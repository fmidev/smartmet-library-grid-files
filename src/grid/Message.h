...
class Message
{
  public:
    ...
    virtual void                  getGridValueListByPolygon(T::CoordinateType coordinateType,std::vector<T::Coordinate>& polygonPoints,double areaExtension,T::GridValueList& valueList);
    virtual void                  getGridValueListByPolygonPath(T::CoordinateType coordinateType,std::vector<std::vector<T::Coordinate>>& polygonPath,double areaExtension,T::GridValueList& valueList);
