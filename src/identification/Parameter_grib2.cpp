...
Parameter_grib2::Parameter_grib2()
{
  try
  {
    mDiscipline = 0;
...
Parameter_grib2::Parameter_grib2(const Parameter_grib2& parameter)
{
  try
  {
...
void Parameter_grib2::print(std::ostream& stream,uint level,uint optionFlags) const
{
  try
  {
    stream << space(level) << "ParameterDefinition_grib2\n";
