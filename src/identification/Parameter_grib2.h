...
class Parameter_grib2
{
  public:

                  Parameter_grib2();
                  Parameter_grib2(const Parameter_grib2& parameter);
    virtual       ~Parameter_grib2();
...
typedef const Parameter_grib2* Parameter_grib2_cptr;
typedef std::vector<Parameter_grib2> Parameter_grib2_vec;
