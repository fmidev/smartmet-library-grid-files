...
void Topology::init(const char* configFile,bool initLandSeaMask,bool initLandShading,bool initSeaShading)
{
  try
  {
    if (mInitialized)
...
void Topology::isLand(const T::Coordinate_vec& coordinates,std::vector<bool>& land)
{
  try
  {
...
void Topology::getLand(const T::Coordinate_vec& coordinates,std::vector<float>& land)
{
  try
  {
    uint sz = coordinates.size();
...
void Topology::getShading(const T::Coordinate_vec& coordinates,std::vector<float>& shadings)
{
  try
  {
    uint sz = coordinates.size();
...
void Topology::getLandShading(const T::Coordinate_vec& coordinates,std::vector<float>& shadings)
{
  try
  {
    uint sz = coordinates.size();
...
void Topology::getSeaShading(const T::Coordinate_vec& coordinates,std::vector<float>& shadings)
{
  try
  {
    uint sz = coordinates.size();
